...
```
### Download the same version of the nvidia driver that is used on the host machine to $HOME/Downalods update the version in the command below to match that. 
```

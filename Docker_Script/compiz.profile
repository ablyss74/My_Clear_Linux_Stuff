...
[core]
s0_active_plugins = core;composite;opengl;copytex;imgjpeg;maximumize;decor;firepaint;grid;imgpng;imgsvg;mousepoll;move;place;put;regex;resize;shelf;text;thumbnail;wobbly;animation;ring;shift;workarounds;fade;addhelper;cube;rotate;scale;td;cubeaddon;
...
[ezoom]
s0_zoom_in_button = <Super>Button1
s0_zoom_in_key = Disabled
s0_zoom_out_button = <Super>Button3
s0_zoom_out_key = <Super>n
